    ...
    <div class="infobox">
      ...
      <div class="space" id="middlespace">
        ...
        <div id="bottombox" class="box">
            <h2>Minhas Redes</h2>
            <div class="socials">
              <a href="https://www.linkedin.com/in/gabriel-n%C3%B3brega-453214378?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank"><img class="icon" src="https://i.ibb.co/v5CVwTg/Linked-In-icon-svg.png" alt="Linked-In-icon-svg" border="0"></a>
                <a href="https://github.com/GabrielNSB007" target="_blank"><img class="icon" src="https://i.ibb.co/ZpTntNJ5/github.png" alt="github" border="0"></a>
                <a href=mailto:"gnsb@cin.ufpe.br" target="_blank"><img class="icon" src="https://i.ibb.co/0p2nmPP9/gmail.png" alt="gmail" border="0"></a>
                <a href="https://www.instagram.com/nobrega_gabriel07" target="_blank"><img class="icon" src="https://i.ibb.co/1Y8zspCG/Instagram-icon.png" alt="Instagram-icon" border="0"></a>
            </div>
        </div>
      </div>
      <div class="space" id="rightspace">
        <div id="topbox" class="box">
          <a href="https://ibb.co/zWTH1LNr" target="_blank"><img class="myphoto" id="eu" src="https://i.ibb.co/NgdnXk7s/pessoa.png" alt="pessoa"></a>
        </div>
    </div>
  </body>
</html>